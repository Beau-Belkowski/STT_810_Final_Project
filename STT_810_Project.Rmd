...
```{r}
#Probability that an Offensive lineman has a longer than average career given that they did participate in the bench press at the combine
...
condition <- Oline1$career_length > 3.256886 # logical condition defining both events
P_both <- sum(condition) / nrow(Oline) # Computing joint probability

prob <- P_both / P_bench # Using Bayes Theorem
cat("The probability of an offensive lineman having an above average career length given that the player did participate in the bench press:",prob)
```
